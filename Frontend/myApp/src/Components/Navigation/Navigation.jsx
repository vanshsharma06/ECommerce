...
export default function Navigation() {
  ...
  return (
    <>
      <nav className="flex items-center justify-between shadow bg-white text-black font-sans flex-wrap text-[6px] sm:text-[10px] md:text-[11px] lg:text-[12px] xl:text-[13px]">
        ...
        <div className="text-[6px] flex flex-wrap justify-center">
          {[
            "Home",
            "Fashion",
            "Electronics",
        ...
        <div className="flex items-center space-x-1 px-2 py-1">
          <RocketLaunch style={{ fontSize: "12px" }} />
