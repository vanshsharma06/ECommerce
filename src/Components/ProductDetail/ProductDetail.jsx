  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 overflow-auto flex items-center justify-center md:p-4">
      ...
      >
        ...
        <button
          onClick={onClose}
          className="absolute top-4 right-4 z-50 text-gray-500 hover:text-gray-800 bg-white rounded-full p-1 shadow-md"
        >
          <X className="h-5 w-5" />
        </button>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="flex flex-col">
              ...
              <p className="mt-4 text-gray-600">
                {product.description ||
                  "This is a high-quality product that offers great value and durability. Perfect for everyday use."}
              </p>
              ...
              {activeTab === "Description" ? (
                <div className="border border-gray-200 rounded-md p-4">
                  <p className="text-gray-700">
                    {product.description ||
                      "This product offers exceptional quality and value. Made with premium materials, it's designed to last and provide a great user experience. Perfect for everyday use and special occasions alike."}
                  </p>
                </div>
              ) : (
