      ...
      */}
      <nav className="flex flex-col items-center px-2 py-3 border bg-white border-t-[1px] border-b-[1px] border-gray-200 sm:px-4 sm:py-1 md:py-2 lg:py-3 lg:px-7 sm:hidden">
        ...
        <div className="flex w-full justify-between items-center">
          ...
          {/* Icons & Login */}
          <div className="flex items-center sm:space-x-3 gap-3 lg:space-x-5 lg:gap-[4px]">
      ...
      <nav className="hidden sm:flex items-center justify-between px-2 py-3 border bg-white border-t-[1px] border-b-[1px]  border-gray-200 space-x-1 sm:px-4 sm:py-1 sm:space-x-2 md:py-2 lg:py-3 lg:px-7">
        {/* Logo */}
        <div className="flex w-full">
          ...
          {/* Search Bar */}
          <div className="relative w-full mx-2 sm:w-100 sm:mx-3 md:w-100 lg:w-180 lg:mx-27">
            <input
              type="text"
              placeholder="Search for products..."
        ...
        <div className="flex items-center sm:space-x-3 gap-2 lg:space-x-5 lg:gap-[4px]">
          <span className="flex justify-center items-center space-x-1 text-gray-700 cursor-pointer lg:gap-[4px]">
            <a
              className="hover:text-red-500 text-[10px] sm:text-[10px] md:text-[11px] lg:text-[14px]"
              href="#"
            >
              Login
            </a>
