      ...
      <footer className="bg-gray-100 text-gray-800 py-10">
        <div className="container mx-auto grid grid-cols-4 md:grid-cols-4">
          ...
          <div>
            ...
            <p className="text-[7px] mt-2 lg:text-[13px]">Classyshop - Mega Super Store</p>
            <p className="text-[7px] lg:text-[13px]">507-Union Trade Centre, France</p>
            <p className="mt-2 text-red-500 font-bold text-[7px] lg:text-[14px]">
              (+91) 9876-543-210
            </p>
            <p className="mt-2 text-[7px] lg:text-[13px]">sales@yourcompany.com</p>
            ...
            <p className="text-[7px] lg:text-[13px] mt-1">Get Expert Help</p>
          </div>

          {/* Products */}
          <div className="mx-3">
            <h3 className="font-semibold text-[11px] lg:text-[16px]">Products</h3>
            <ul className="mt-2 space-y-2 text-[7px] lg:text-[13px]">
              <li>
          ...
          <div>
            ...
            <p className="mt-2 text-[7px] lg:text-[13px]">
            ...
            <input
              ...
              className="mt-3 w-full p-1 text-[7px] lg:text-[13px] lg:py-[10px] lg:px-[10px] border border-gray-300 rounded-md"
            />
            <button className="mt-3 w-[80px] bg-red-500 text-white p-2 text-[7px] lg:text-[13px] rounded-md hover:bg-red-600">
              SUBSCRIBE
            </button>
            <div className="mt-2 flex items-center">
              <input type="checkbox" id="terms" className="mr-2" />
              <label htmlFor="terms" className="text-[7px] lg:text-[13px]">
        ...
        {/* Copyright */}
        <div className="text-center text-[7px] lg:text-[13px] text-gray-500 mt-4 mb-[-30px] ">
